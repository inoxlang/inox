...
type NodeBase struct {
	...
	Err             *sourcecode.ParsingError `json:"error,omitempty"`
...
type MarkupElement struct {
	...
	EstimatedRawElementType RawElementType           `json:"estimatedRawElementType,omitempty"` //empty if not found
}
...
func NewMarkupText(span sourcecode.NodeSpan, raw string) *MarkupText {
	return &MarkupText{
		NodeBase: NodeBase{
			Span: span,
		},
