...
func TestGetNodeAtSpan(t *testing.T) {
	...
	t.Run("shallow", func(t *testing.T) {
		t.Run("", func(t *testing.T) {
			...
			assert.IsType(t, &ast.IdentifierLiteral{}, node)
		...
		t.Run("span starting at exclusive end of node", func(t *testing.T) {
			...
			assert.IsType(t, &ast.Chunk{}, node)
		})
	})
	...
	t.Run("deep", func(t *testing.T) {
		t.Run("", func(t *testing.T) {
			...
			assert.IsType(t, &ast.PatternIdentifierLiteral{}, node)
		...
		t.Run("span starting at exclusive end of node", func(t *testing.T) {
			...
			node, ok := chunk.GetNodeAtSpan(NodeSpan{Start: 8, End: 9}) //the 'div' identifier ends at 8.
			if !assert.True(t, ok) {
				return
			}
			assert.IsType(t, &ast.MarkupOpeningTag{}, node)
		})
		...
		t.Run("empty span within an identifier", func(t *testing.T) {
			...
			if !assert.IsType(t, &ast.IdentifierLiteral{}, node) {
				return
			}

			assert.Equal(t, "div", node.(*ast.IdentifierLiteral).Name)
		})
		...
		t.Run("empty span at a node with an empty span", func(t *testing.T) {
			...
			assert.IsType(t, &ast.MarkupElement{}, node)
		})
	})
...
func TestFindFirstStatementAndChainOnLine(t *testing.T) {
	...
	t.Run("single line chunk", func(t *testing.T) {
		...
		t.Run("single statement", func(t *testing.T) {
			...
			expectedNode, expectedAncestors := ast.FindNodeAndChain(chunk.Node, (*ast.IntLiteral)(nil), nil)
		...
		t.Run("single multi-node statement", func(t *testing.T) {
			...
			expectedNode, expectedAncestors := ast.FindNodeAndChain(chunk.Node, (*ast.CallExpression)(nil), nil)
		...
		t.Run("two statements", func(t *testing.T) {
			...
			expectedNodes, expectedAncestors := ast.FindNodesAndChains(chunk.Node, (*ast.IntLiteral)(nil), nil)
