...
const (
	...
	UNTERMINATED_MARKUP_EXPRESSION_MISSING_TOP_ELEM_NAME              = "unterminated xml expression: missing name of top element"
	UNTERMINATED_MARKUP_PATTERN_EXPRESSION_MISSING_TOP_ELEM_NAME      = "unterminated xml pattern expression: missing name of top element"
	UNTERMINATED_OPENING_MARKUP_TAG_MISSING_CLOSING                   = "unterminated opening xml tag: missing closing delimiter '>'"
	UNTERMINATED_SELF_CLOSING_MARKUP_TAG_MISSING_CLOSING              = "unterminated self-closing xml tag: missing closing '>' after '/'"
	UNTERMINATED_MARKUP_INTERP                                        = "unterminated xml interpolation"
	UNTERMINATED_CLOSING_MARKUP_TAG_MISSING_CLOSING_DELIM             = "unterminated closing xml tag: missing closing delimiter '>' after tag name"
	UNTERMINATED_HYPERSCRIPT_ATTRIBUTE_SHORTHAND                      = "unterminated hyperscript attribute shorthand"
	EMPTY_MARKUP_INTERP                                               = "xml interpolation should not be empty"
	INVALID_MARKUP_INTERP                                             = "invalid xml interpolation"
	MARKUP_INTERP_SHOULD_CONTAIN_A_SINGLE_EXPR                        = "an xml interpolation should contain a single expression"
	MARKUP_ATTRIBUTE_NAME_SHOULD_BE_IDENT                             = "xml attribute's name should be an identifier"
