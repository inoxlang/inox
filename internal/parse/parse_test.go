							...
							Properties: []*ObjectProperty{
								{
									NodeBase: NodeBase{
										NodeSpan{1, 4},
										&ParsingError{UnspecifiedParsingError, INVALID_OBJ_REC_ENTRY_ENTRY_SEPARATION},
										false,
									},
									Key: &IdentifierLiteral{
	...
	t.Run("for expression", func(t *testing.T) {
		...
		t.Run("for <index pattern> <index>, <elem> ... in", func(t *testing.T) {
			...
			assert.EqualValues(t, &Chunk{
				...
				Statements: []Node{
					&ForExpression{
						NodeBase: NodeBase{Span: NodeSpan{0, 31}, IsParenthesized: true},
						KeyPattern: &PatternIdentifierLiteral{
		...
		t.Run("for <index pattern> <index>, <elem pattern> <elem> ... in", func(t *testing.T) {
			...
			assert.EqualValues(t, &Chunk{
				...
				Statements: []Node{
					&ForExpression{
						NodeBase: NodeBase{Span: NodeSpan{0, 34}, IsParenthesized: true},
						KeyPattern: &PatternIdentifierLiteral{
							NodeBase: NodeBase{NodeSpan{5, 10}, nil, false},
							Name:     "even",
						},
		...
		t.Run("for <elem> ... in", func(t *testing.T) {
			...
			assert.EqualValues(t, &Chunk{
				...
				Statements: []Node{
					&ForExpression{
						NodeBase:      NodeBase{Span: NodeSpan{0, 22}, IsParenthesized: true},
						KeyIndexIdent: nil,
						ValueElemIdent: &IdentifierLiteral{
							NodeBase: NodeBase{NodeSpan{5, 6}, nil, false},
							Name:     "u",
				...
				Statements: []Node{
					&Assignment{
						...
						Right: &BinaryExpression{
							...
							Operator: Add,
							Left: &UnaryExpression{
								NodeBase: NodeBase{Span: NodeSpan{4, 7}},
								Operator: NumberNegate,
								Operand: &Variable{
									NodeBase: NodeBase{NodeSpan{5, 7}, nil, false},
									Name:     "a",
		...
		t.Run("unexpected keyword operator : <and>e", func(t *testing.T) {
			...
			assert.EqualValues(t, &Chunk{
				...
				Statements: []Node{
					...
					&CallExpression{
						NodeBase: NodeBase{NodeSpan{7, 14}, nil, false},
						Callee: &IdentifierLiteral{
