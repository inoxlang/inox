...
var (
	...
	_ = []core.GoValue{
		...
		(*ws_ns.WebsocketConnection)(nil), (*http_ns.Request)(nil), (*http_ns.ResponseWriter)(nil),
		(*fs_ns.File)(nil),
	}
)
...
func NewDefaultGlobalState(ctx *core.Context, conf core.DefaultGlobalStateConfig) (*core.GlobalState, error) {
	...
	constants := map[string]core.Value{
		...
		globalnames.FILTER_ITERABLE_FN: core.WrapGoFunction(Filter),
		globalnames.GET_AT_MOST_FN:     core.WrapGoFunction(GetAtMost),
		globalnames.SOME_FN:            core.WrapGoFunction(Some),
		globalnames.ALL_FN:             core.WrapGoFunction(All),
		globalnames.NONE_FN:            core.WrapGoFunction(None),
