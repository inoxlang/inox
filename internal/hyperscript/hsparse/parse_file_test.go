...
func TestParseHyperscriptFile(t *testing.T) {
	...
	t.Run("valid", func(t *testing.T) {
		...
		file, err := ParseFile(context.Background(), chunkSource, nil)
	...
	t.Run("cache", func(t *testing.T) {
		...
		file, err := ParseFile(context.Background(), chunkSource, cache)
		...
		_file, _err := ParseFile(context.Background(), chunkSource, cache)
