...
func TestNilPrettyPrint(t *testing.T) {
	...
	assert.Equal(t, Nil, utils.Must(EvalSimpleValueLiteral(node.(ast.SimpleValueLiteral), nil)))
}
...
func TestBoolPrettyPrint(t *testing.T) {
	...
	assert.Equal(t, True, utils.Must(EvalSimpleValueLiteral(node.(ast.SimpleValueLiteral), nil)))
}
...
func TestRunePrettyPrint(t *testing.T) {
	...
	assert.Equal(t, Rune('a'), utils.Must(EvalSimpleValueLiteral(node.(ast.SimpleValueLiteral), nil)))
}
...
func TestIntPrettyPrint(t *testing.T) {
	...
	assert.Equal(t, Int(2), utils.Must(EvalSimpleValueLiteral(node.(ast.SimpleValueLiteral), nil)))
}
...
func TestFloatPrettyPrint(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(strconv.Itoa(int(testCase.value)), func(t *testing.T) {
			...
			assert.Equal(t, testCase.value, utils.Must(EvalSimpleValueLiteral(node.(ast.SimpleValueLiteral), nil)))
		})
	}
}
...
func TestStrPrettyPrint(t *testing.T) {
	...
	t.Run("newline character", func(t *testing.T) {
		...
		assert.Equal(t, s, utils.Must(EvalSimpleValueLiteral(node.(ast.SimpleValueLiteral), nil)))
	})
...
func TestPathPrettyPrint(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.value, func(t *testing.T) {
			...
			assert.Equal(t, pth, utils.Must(EvalSimpleValueLiteral(node.(ast.SimpleValueLiteral), nil)))
		})
	}
...
func TestPathPatternPrettyPrint(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.value, func(t *testing.T) {
			...
			node := assertParseExpression(t, testCase.representation)
			assert.Equal(t, patt, utils.Must(EvalSimpleValueLiteral(node.(ast.SimpleValueLiteral), nil)))
		})
	}
...
func TestURLPrettyPrint(t *testing.T) {
	...
	node := assertParseExpression(t, expectedRepr)
	assert.Equal(t, url, utils.Must(EvalSimpleValueLiteral(node.(ast.SimpleValueLiteral), nil)))
...
func TestHostPrettyPrint(t *testing.T) {
	...
	node := assertParseExpression(t, expectedRepr)
	assert.Equal(t, host, utils.Must(EvalSimpleValueLiteral(node.(ast.SimpleValueLiteral), nil)))
	//TODO: test more complex cases
}
...
func TestLineCountPrettyPrint(t *testing.T) {
	...
	node := assertParseExpression(t, expectedRepr)
	assert.Equal(t, n, utils.Must(EvalSimpleValueLiteral(node.(ast.SimpleValueLiteral), nil)))
	//TODO: test more complex cases
}
...
func TestFrequencyPrettyPrint(t *testing.T) {
	...
	for _, testCase := range freqReprTestCases {
		t.Run(strconv.Itoa(int(testCase.value)), func(t *testing.T) {
			...
			evalResult := utils.Must(EvalSimpleValueLiteral(node.(ast.SimpleValueLiteral), nil))
...
func assertParseExpression(t *testing.T, s string) ast.Node {
