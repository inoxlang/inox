...
func init() {
	...
	symbolic.SetExternalData(symbolic.ExternalData{
		...
		// TreeWalkEvalEmptyState: func(node ast.Node) (any, error) {
		...
		EstimatePermissionsFromListingNode: func(n *ast.ObjectLiteral) (any, error) {
		...
		ConcreteValueFactories: symbolic.ConcreteValueFactories{
			...
			CreateSequenceStringPattern: func(concreteCtx symbolic.ConcreteContext, n *ast.ComplexStringPatternPiece) (any, error) {
