...
func TestParseRepr(t *testing.T) {
	...
	testCases := []struct {
		...
		// {`#{a:true,"b":false}`, -1, NewRecordFromMap(ValMap{"a": True, "b": False})},
		// {`#{"a":true,b:false}`, -1, NewRecordFromMap(ValMap{"a": True, "b": False})},
		// /*        */ {`#{"a":[]}`, -1, NewRecordFromMap(ValMap{"a": NewWrappedValueList()})},
		// /*        */ {`#{"a":[1]}`, -1, NewRecordFromMap(ValMap{"a": NewWrappedValueList(Int(1))})},
		// /*        */ {`#{"a":[{a:true}]}`, -1, NewRecordFromMap(ValMap{"a": NewWrappedValueList(objFrom(ValMap{"a": True}))})},
		// /*        */ {`#{"a":[{a:true,b:false}]}`, -1, NewRecordFromMap(ValMap{"a": NewWrappedValueList(objFrom(ValMap{"a": True, "b": False}))})},
		// /*        */ {`#{"a":{a:true}}`, -1, NewRecordFromMap(ValMap{"a": objFrom(ValMap{"a": True})})},
		// /*        */ {`#{"a":{a:true,b:false}}`, -1, NewRecordFromMap(ValMap{"a": objFrom(ValMap{"a": True, "b": False})})},
		// /*        */ {`#{"a":[], b: []}`, -1, NewRecordFromMap(ValMap{"a": NewWrappedValueList(), "b": NewWrappedValueList()})},
		// /*        */ {`#{"a":[1], b: [2]}`, -1, NewRecordFromMap(ValMap{"a": NewWrappedValueList(Int(1)), "b": NewWrappedValueList(Int(2))})},
