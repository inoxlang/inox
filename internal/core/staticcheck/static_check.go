...
func (checker *checker) makeCheckingError(node parse.Node, s string) *Error {
...
func NewError(s string, location parse.SourcePositionStack) *Error {
	return &Error{
...
func (err Error) LocationStack() parse.SourcePositionStack {
	return err.Location
}
