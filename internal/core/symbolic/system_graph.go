...
func (g *SystemGraph) SetProp(state *State, node ast.Node, name string, value Value) (IProps, error) {
...
func (n *SystemGraphNode) SetProp(state *State, node ast.Node, name string, value Value) (IProps, error) {
...
func (n *SystemGraphEvent) SetProp(state *State, node ast.Node, name string, value Value) (IProps, error) {
	return nil, errors.New(FmtCannotAssignPropertyOf(n))
}
...
func (e *SystemGraphEdge) SetProp(state *State, node ast.Node, name string, value Value) (IProps, error) {
