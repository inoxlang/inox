...
func TestSymbolicString(t *testing.T) {
	...
	t.Run("Test()", func(t *testing.T) {
		...
		assertTestFalse(t, strMatchingSeq1, NewStringMatchingPattern(NewExactStringPattern(NewString("x"))))
		...
		assertTestFalse(t, strMatchingSeq2, NewStringMatchingPattern(NewExactStringPattern(NewString("x"))))
		assertTestFalse(t, strMatchingSeq2, NewStringMatchingPattern(NewExactStringPattern(NewString("x"))))
