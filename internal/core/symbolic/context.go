...
func (ctx *Context) AddLocatedSymbolicGoFunctionError(location ast.Node, msg string) {
...
func (ctx *Context) AddLocatedSymbolicGoFunctionErrorf(location ast.Node, fmtS string, args ...any) {
