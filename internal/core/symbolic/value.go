...
type IProps interface {
	...
	SetProp(state *State, node ast.Node, name string, value Value) (IProps, error)
...
func (UnassignablePropsMixin) SetProp(state *State, node ast.Node, name string, value Value) (IProps, error) {
