...
func fmtCannotCallNode(node ast.Node) string {
...
func fmtInvalidBinaryOperator(operator ast.BinaryOperator) string {
...
func fmtLeftOperandOfBinaryShouldBe(operator ast.BinaryOperator, expectedType string, actual string) string {
	return fmt.Sprintf("left operand of binary '%s' should be a(n) %s but is %s", operator.String(), expectedType, actual)
}

func fmtLeftOperandOfBinaryShouldBeImmutable(operator ast.BinaryOperator) string {
	return fmt.Sprintf("left operand of binary '%s' should be immutable", operator.String())
}

func fmtRightOperandOfBinaryShouldBe(operator ast.BinaryOperator, expectedType string, actual string) string {
	return fmt.Sprintf("right operand of binary '%s' should be a(n) %s but is %s", operator.String(), expectedType, actual)
}

func fmtRightOperandOfBinaryShouldBeImmutable(operator ast.BinaryOperator) string {
	return fmt.Sprintf("right operand of binary '%s' should be immutable", operator.String())
}

func fmtRightOperandOfBinaryShouldBeLikeLeftOperand(operator ast.BinaryOperator, expectedType string, actual string) string {
...
func fmtRightOperandForIntArithmetic(right Value, operator ast.BinaryOperator) string {
	return fmtRightOperandOfBinaryShouldBe(operator, "int", Stringify(right))
}

func fmtRightOperandForFloatArithmetic(right Value, operator ast.BinaryOperator) string {
	return fmtRightOperandOfBinaryShouldBe(operator, "float", Stringify(right))
}

func fmtExpectedLeftOperandForArithmetic(left Value, operator ast.BinaryOperator) string {
