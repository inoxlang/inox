 ...
 */
declare function marked(src: string, options: marked.MarkedOptions & {async: true}): Promise<string>;
 ...
 */
declare function marked(src: string, callback: (error: any, parseResult: string) => void): void;
...
declare class Lexer extends marked.Lexer {}
declare class Parser extends marked.Parser {}
declare class Tokenizer<T = never> extends marked.Tokenizer<T> {}
declare class Renderer<T = never> extends marked.Renderer<T> {}
