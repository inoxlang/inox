/* 
    note: after the function expression htmx.config.includeIndicatorStyles is set to false to avoid CSP errors
    due to inline styles. The json-enc extension is also included.
*/
